...
namespace Biblioteca_WebForms.DAL
{
    ...
    partial void DeleteSocio(Socio instance);
		...
		public System.Data.Linq.Table<v_ListadoAlquilere> v_ListadoAlquileres
		{
			get
			{
				return this.GetTable<v_ListadoAlquilere>();
			}
		}
	}
			...
			set
			{
							...
							|| (this._Socio.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Alquiler.Remove(this);
					}
					this._Socio.Entity = value;
					if ((value != null))
					{
						value.Alquiler.Add(this);
	...
	public partial class Socio : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Alquiler> _Alquiler;
    ...
    partial void OnTelefonoChanged();
		...
		public Socio()
		{
			this._Alquiler = new EntitySet<Alquiler>(new Action<Alquiler>(this.attach_Alquiler), new Action<Alquiler>(this.detach_Alquiler));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Socio_Alquiler", Storage="_Alquiler", ThisKey="IdSocio", OtherKey="FKSocio")]
		public EntitySet<Alquiler> Alquiler
		{
			get
			{
		...
		private void attach_Alquiler(Alquiler entity)
		{
			this.SendPropertyChanging();
			entity.Socio = this;
		}
		
		private void detach_Alquiler(Alquiler entity)
		{
			this.SendPropertyChanging();
			entity.Socio = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.v_ListadoAlquileres")]
	public partial class v_ListadoAlquilere
	{
		...
		public v_ListadoAlquilere()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IdEjemplar", DbType="Int NOT NULL")]
		public int IdEjemplar
		{
			get
			{
